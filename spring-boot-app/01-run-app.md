...
The Spring Boot application is Maven-based, so in the Terminal please start the application with:
...
In this module, we'll be using HTTPie to interface with the API.
